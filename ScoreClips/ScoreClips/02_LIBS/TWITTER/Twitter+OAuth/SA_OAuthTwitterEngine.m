...
// TrongV - 04/02/2013 - Support post Image to TW
- (NSString *)  postImageTW:(NSData *)imageData
                     status:(NSString *)status
                        lat:(NSString *)lat
                       lon:(NSString *)lon;
{
    
    MGTwitterRequestType requestType = MGTwitterPostPhotoRequest;
    MGTwitterResponseType responseType = MGTwitterStatuses;
