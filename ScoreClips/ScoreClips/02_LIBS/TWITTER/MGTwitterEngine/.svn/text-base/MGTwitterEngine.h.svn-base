...
@interface MGTwitterEngine : NSObject <MGTwitterParserDelegate> {
    __unsafe_unretained id <MGTwitterEngineDelegate> _delegate;
    NSString *_username;
    NSString *_password;
...
- (NSString *)sendUpdate:(NSString *)status andLat:(NSString *)latTitue andLong: (NSString*)longTitue;//ThinhHQ 2012/2/22
