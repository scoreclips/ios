...
- (NSString *)sendUpdate:(NSString *)status withLocation:(NSString *) coordinateString; // statuses/update / coordinateString (lat,long)
- (NSString *)sendUpdate:(NSString *)status inReplyTo:(unsigned long)updateID withLocation:(NSString *) coordinateString; // statuses/update
