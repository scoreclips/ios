...
//- (void)saveImageForDelegate:(id<SDWebImageManagerDelegate>)delegate image:(UIImage*)image {
//    NSUInteger idx;
//    idx = [downloadDelegates indexOfObjectIdenticalTo:delegate];
//    if (idx == NSNotFound)
//    {
...
- (void)imageCache:(SDImageCache *)imageCache didFindImage:(UIImage *)image forKey:(NSString *)key userInfo:(NSDictionary *)info
{
    ...
    // MinhPB 2012/07/25
//    if ([self imageWithURL:[NSURL URLWithString:key]]) {
//        NSLog(@"imageCache didFindImage has image");
//    }
//    else {
//        NSLog(@"imageCache didFindImage do not has image");
//    }
...
- (void)imageCache:(SDImageCache *)imageCache didNotFindImageForKey:(NSString *)key userInfo:(NSDictionary *)info
{
    ...
    // MinhPB 2012/07/25
//    if ([self imageWithURL:[NSURL URLWithString:key]]) {
//        NSLog(@"imageCache didNotFindImageForKey has image");
//    }
//    else {
//        NSLog(@"imageCache didNotFindImageForKey do not has image");
//    }
